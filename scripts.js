...
storeApp.init = function () {
  ...
  buttons.forEach((button) => {
    button.addEventListener('click', function () {
      ...
      storeApp.displayItems(storeApp.currentStock, storeApp.currency);

      const currentFlag = document.querySelector('flag');
      currentFlag.src = storeApp.currency.flag;
      currentFlag.alt = storeApp.currency.displayName

      document.querySelector('currency').textContent = storeApp.currency.displayName;
    })
  })
